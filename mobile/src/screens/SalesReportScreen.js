...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 13, fontWeight: 'bold', color: '#1e293b', letterSpacing: 1 },
    refreshBtn: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, backgroundColor: '#f1f5f9' },
    refreshText: { fontSize: 12, fontWeight: 'bold', color: '#64748b' },
    tabsContainer: { flexDirection: 'row', backgroundColor: '#e2e8f0', marginHorizontal: 15, marginTop: 15, borderRadius: 12, padding: 4 },
    tab: { flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: 8 },
    tabActive: { backgroundColor: '#fff' },
    tabText: { fontSize: 13, fontWeight: 'bold', color: '#64748b' },
    tabTextActive: { color: '#1e293b' },
    statsCard: { backgroundColor: '#fff', marginHorizontal: 15, marginTop: 15, borderRadius: 20, padding: 18, shadowColor: '#1e1b4b', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.03, shadowRadius: 10, elevation: 2 },
    revenueBlock: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 },
    revenueInfo: { flex: 1 },
    revenueLabel: { fontSize: 9, fontWeight: '900', color: '#94a3b8', letterSpacing: 1 },
    revenueValue: { fontSize: 24, fontWeight: 'bold', color: '#1e293b', marginTop: 2 },
    ...
    breakdownVal: { fontSize: 13, fontWeight: 'bold', color: '#1e293b' },
    breakdownLbl: { fontSize: 10, color: '#94a3b8', fontWeight: 'bold' },
    ...
    saleHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#f1f5f9', paddingBottom: 10 },
    saleId: { fontSize: 13, fontWeight: 'bold', color: '#1e293b' },
    saleTime: { fontSize: 11, color: '#94a3b8', fontWeight: '500', marginTop: 2 },
    ...
    clientBadge: { alignSelf: 'flex-start', backgroundColor: '#f0f2ff', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, marginTop: 8 },
    clientBadgeText: { fontSize: 11, fontWeight: 'bold', color: '#4f46e5' },
    itemsList: { marginTop: 12, gap: 8 },
    productRow: { flexDirection: 'row', alignItems: 'center' },
    productThumb: { width: 32, height: 32, borderRadius: 6, backgroundColor: '#f8fafc' },
    productThumbPlaceholder: { width: 32, height: 32, borderRadius: 6, backgroundColor: '#f8fafc', alignItems: 'center', justifyContent: 'center' },
    productInfo: { flex: 1, marginLeft: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    productName: { fontSize: 13, fontWeight: '500', color: '#1e293b', flex: 1, marginRight: 10 },
    ...
    emptyText: { fontSize: 14, color: '#94a3b8', fontWeight: 'bold', textAlign: 'center', paddingHorizontal: 40 }
});
