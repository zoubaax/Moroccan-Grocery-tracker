...
const styles = StyleSheet.create({
    ...
    avatarLarge: { width: 70, height: 70, borderRadius: 35, backgroundColor: '#fff4ee', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
    avatarLargeText: { fontSize: 26, fontWeight: 'bold', color: '#a14009' },
    profileName: { fontSize: 20, fontWeight: 'bold', color: '#002045' },
    profilePhoneRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6, marginBottom: 15 },
    profilePhone: { fontSize: 14, color: '#74777f', fontWeight: '500' },
    ...
    cardTitle: { fontSize: 13, fontWeight: 'bold', color: '#74777f', marginBottom: 12, letterSpacing: 0.5 },
    payInputRow: { flexDirection: 'row', gap: 12 },
    payInput: { flex: 1, height: 48, borderWidth: 1, borderColor: '#e3e2e6', borderRadius: 12, paddingHorizontal: 15, fontSize: 15, color: '#002045', fontWeight: '600' },
    payBtn: { height: 48, paddingHorizontal: 20, backgroundColor: '#a14009', borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
    payBtnText: { color: '#fff', fontSize: 14, fontWeight: 'bold' },
    historySectionTitle: { marginHorizontal: 20, marginTop: 25, marginBottom: 12, fontSize: 13, fontWeight: 'bold', color: '#74777f', letterSpacing: 0.5 },
    ...
    txnHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#e3e2e6', paddingBottom: 10, marginBottom: 10 },
    txnIdRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    txnId: { fontSize: 12, fontWeight: 'bold', color: '#002045' },
    txnDate: { fontSize: 11, color: '#74777f', fontWeight: '500' },
    txnItems: { gap: 6, marginBottom: 12 },
    txnItemRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
    txnProductThumb: { width: 28, height: 28, borderRadius: 6, backgroundColor: '#faf9fd' },
    txnProductThumbPlaceholder: { width: 28, height: 28, borderRadius: 6, backgroundColor: '#faf9fd', alignItems: 'center', justifyContent: 'center' },
    txnProductInfo: { flex: 1, marginLeft: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    txnItemText: { fontSize: 13, color: '#002045', fontWeight: '500', flex: 1, marginRight: 10 },
    txnItemQty: { fontSize: 12, color: '#74777f' },
    txnFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 8, borderTopWidth: 1, borderTopColor: '#faf9fd' },
    ...
    badgeCash: { backgroundColor: '#e3e2e6', color: '#002045' },
    txnTotal: { fontSize: 15, fontWeight: 'bold', color: '#002045' },
    emptyHistory: { alignItems: 'center', marginTop: 30 },
    emptyHistoryText: { fontSize: 14, color: '#74777f', marginTop: 10, fontWeight: 'bold' },
